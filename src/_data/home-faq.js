...
module.exports = [
  ...
  },
  {
    no: '03',
    question: '場租方案怎麼算？',
    body: '不論是剛起步的自由教練或已經營品牌許久的專業教練，我們都有對應的場租方案，提供單堂與包月等不同選擇。交通便利、機車好停，附近也有汽車停車場。詳細費用如下：',
    /* name 與 price 成對，term 只有月租用得到 */
    plans: [
      { name: '月租', term: '不限堂數・30 天', price: 'NT$10,000' },
      { name: '10 堂', price: 'NT$3,000' },
      { name: '20 堂', price: 'NT$5,000' },
      { name: '40 堂', price: 'NT$8,000' },
    ],
    notes: ['非月租教練使用 InBody，一次 150 元', '一對二單堂加收 50 元'],
  },
];
